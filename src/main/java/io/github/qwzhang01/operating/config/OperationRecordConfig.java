 ...
 * <p>Registered beans:
 * <ul>
 *   <li>{@link SpringKit} - Utility for accessing Spring application context</li>
 *   <li>{@link DefaultOpStrategy} - Default strategy for operation recording</li>
 ...
 * application context, thanks to the {@link ConditionalOnMissingBean} annotations.
 */
@Configuration
public class OperationRecordConfig {
     ...
     * This aspect intercepts methods annotated with {@link io.github.qwzhang01.operating.anno.Op}
     * and orchestrates the operation recording process.
     * 
     * @return a new OpAspect instance configured with before and after processors
     */
    @Bean
