 ...
 * 
 * This processor extracts the relevant argument from the method's parameter list
 * based on the type specified in the {@link Op} annotation's args attribute.
 * 
...
public class ArgsProcessor {
    ...
    /**
     * Processes method arguments to extract the relevant data for operation recording.
     * 
     * <p>This method iterates through all method arguments and returns the first
     * argument that matches the type specified in {@code op.args()}. This allows
     ...
     * @return the first argument matching the configured type, or null if no match is found
     */
